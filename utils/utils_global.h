...
#  define UTILSJSON_EXPORT Q_DECL_EXPORT
#  define TIMESTAMPSIMULATOR_EXPORT Q_DECL_EXPORT
#else
...
#  define UTILSJSON_EXPORT Q_DECL_IMPORT
#  define TIMESTAMPSIMULATOR_EXPORT Q_DECL_IMPORT
#endif
